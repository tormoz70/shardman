CREATE TABLE IF NOT EXISTS cluster_config (
    ...
    bucket_axis     VARCHAR(16) NOT NULL,
    bucket_spec     JSONB NOT NULL,
    shard_max_bytes BIGINT NOT NULL,
    retention_depth INT,
    max_future_buckets INT,
...
CREATE UNIQUE INDEX IF NOT EXISTS shards_one_active_per_bucket
    ON shards (bucket_id)
...
CREATE INDEX IF NOT EXISTS shards_bucket_id_idx ON shards(bucket_id);
